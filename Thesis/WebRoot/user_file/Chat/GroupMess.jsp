...
<table width="70%"  align="center" border="0"  bordercolor="#1D67DD" style="background-color:#F4F4F4" background="images/faceimges/whiteBg.png">
      <tr>
        <td height="733"><table width="100%" height="735" border="0" cellpadding="1" cellspacing="0" bordercolor="#0000FF">
          <tr>
            <td colspan="3" rowspan="2">
              
              <textarea  readonly name="textarea"  style="width:99%; height:99.5%; background:url(images/faceimges/whiteBg.png)"></textarea>
           </td>
            <td height="46"><img src="images/21.jpg" width="100%" height="48" /></td>
          </tr>
          <tr>
            <td rowspan="3">&nbsp;</td>
          </tr>
          <tr>
            <td width="126" height="41"><img src="images/321.jpg" width="100%" height="43" /></td>
            <td width="247">&nbsp;</td>
            <td width="181">&nbsp;</td>
          </tr>
          <tr>
            <td height="143" colspan="3"> <textarea readonly
											name="textarea"
											style="width:99%; height:99.5%; background:url(images/faceimges/whiteBg.png)"></textarea>
									</td>
          </tr>
          <tr>
            <td height="34" colspan="4"><select name="select2"  style=" width:120px;height:100%; color:#0000FF">
            ...
            <span class="STYLE3">私密会话            </span></label></td>
          </tr>
          <tr>
            <td height="30" colspan="3"><textarea name="text"  style=" width:100%"></textarea></td>

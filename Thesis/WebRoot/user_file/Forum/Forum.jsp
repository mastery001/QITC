							...
							<div id="bannerBox">
								<div id="bannerImgesBox">
									<a style="z-index:7; display:block;"><img
										...
										target="_parent"><img src="images/lunwen/Img378564923.jpg"
										height="453"> </a> <a
										href=""
										target="_parent"><img
								...
								<div id="bannerTextBox">
									<ul>
										...
										<li set="5"><a href="#">6</a></li>
										<li set="6"><a href="#">7</a></li>
									</ul>
								</div>
							</div>
						</td>
							...
							<td height="230" colspan="2"><table width="100%"
									...
									<tr>
										<td width="115" height="103" rowspan="2"><img
											src="${entry.image }" width="149" height="146" />
										</td>
										<td height="38"><font color="#f00">标题：</font><span
											class="STYLE14">${entry.title }</span></td>
									...
									<tr>
										...
										<td width="412"><div align="center" class="STYLE12"><a href="Forum.query.do?p_id=${entry.a_id }&show=body">进入论帖</a></div>
										</td>
					...
					<tr>
						<td height="67" colspan="2"><div align="center"
								...
								<a>共有${page.count}条记录</a> <a>当前第${page.page}页</a> <a
									href="Forum.query.do?isleaf=0&firstIndex=1">首页</a> <a
									href="Forum.query.do?isleaf=0&firstIndex=${page.page-1<=1?1:page.page- 1}">上一页</a>
								<a
									href="Forum.query.do?isleaf=0&firstIndex=${page.page + 1 >=page.lastPage?page.lastPage:page.page + 1}">下一页</a>
								<a href="Forum.query.do?isleaf=0&firstIndex=${page.lastPage}">末页</a>
							</div></td>
					</tr>
				</table></td>
		</tr>

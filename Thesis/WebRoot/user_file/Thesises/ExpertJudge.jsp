...
<tr>
<td width="77%" height="26" bgcolor="1D67DD"><span class="STYLE4">论文审核::</span></td>
<td width="33%" bgcolor="1D67DD"><span class="STYLE4">提示：非本人操作请自觉。</span></td>
</tr>
</table>
  ...
  <td height="753"><table width="100%" height="1031" border="0">
    ...
    <tr>
      <td height="536"><table width="80%" height="563" border="1" cellspacing="0" bordercolor="#0000FF" align="center">
        <tr>
          <td height="30" colspan="2"><div align="center">评审专家审核论文</div></td>
          </tr>
        <tr>
        ...
        <tr>
          <td height="31" colspan="2"><div align="center">评审专家评语</div></td>
          </tr>
        <tr>

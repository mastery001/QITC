								...
								<table width="100%" id="imgid" class="textbox" border="1"
									...
									<c:otherwise>
										<table width="100%" id="imgid" class="textbox" border="1"
											...
											<tr>
												<td width="56%" rowspan="4"><img
													src="${entry.t_front }" alt="" width="180" height="165" />
												</td>
										...
										<tr>
											<td height="66" colspan="3"><center>
													...
													<c:choose>
														...
														<c:otherwise>
															<a
																href="Thesises.query.do?isdelete=0&c_id=${user.c_id}&commit_status=1&firstIndex=1"><span
																class="STYLE2">【首页】</span> </a>
															<a
																href="Thesises.query.do?isdelete=0&c_id=${user.c_id}&commit_status=1&firstIndex=${page.page-1<=1?1:page.page- 1}"><span
																class="STYLE2">【上一页】</span> </a>
															<a
																href="Thesises.query.do?isdelete=0&c_id=${user.c_id}&commit_status=1&firstIndex=${page.page + 1 >=page.lastPage?page.lastPage:page.page + 1}"><span
																class="STYLE2">【下一页】</span> </a>
															<a
																href="Thesises.query.do?isdelete=0&c_id=${user.c_id}&commit_status=1&firstIndex=${page.lastPage}"><span
																class="STYLE2">【末页】</span> </a>
														</c:otherwise>
													</c:choose>

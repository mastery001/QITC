							...
							<table width="100%" border="0">
								<tr>
									<td colspan="2"><div align="center">
											<c:choose>
												<%--当用户不存在密码时 --%>
												<c:when test="${user1.pspb1 == null || user1.pspb2 == null || user1.pspb3 == null}">
													<form action="u.do?op=pp" method="post">
														...
														<table border="0" width="50%">
															...
															<tr>
																<td height="30">&nbsp;</td>
																<td width="42%" height="30"><label></label>
																</td>
																<td width="39%">&nbsp;</td>
															</tr>
															<tr>
																<td height="50"><input type="submit" name="Submit2"
												...
												<c:otherwise>
													<form action="u.do?op=pp&v=vd" method="post">
														<input type="hidden" name="u_id" value="${user.u_id }" />
														<table border="0" width="50%">
															<tr>
																<td colspan="3" align="center"><font color="#f00" size="3">该用户已设置过密码，如需修改请验证！</font>
																</td>
															</tr>
															<tr>
																<td height="50"><div align="right" class="STYLE5">问题1：</div>
																...
																<td height="50" colspan="2"><input disabled
																	type="text" name="pspb1" value="${user1.pspb1 }" style="width:200px;color:#0000FF; height:25px">
																</td>
															</tr>
															<tr>
																<td width="19%" height="50"><div align="right"
															...
															<tr>
																...
																<td height="50" colspan="2"><input disabled
																	type="text" name="pspb2" value="${user1.pspb2 }" style="width:200px;color:#0000FF; height:25px">
																</td>
															</tr>
															<tr>
																<td height="50"><div align="right" class="STYLE5">回答：</div>
															...
															<tr>
																...
																<td height="50" colspan="2"><input disabled
																	type="text" name="pspb3" value="${user1.pspb3 }" style="width:200px;color:#0000FF; height:25px">
																</td>
															</tr>
															<tr>
																<td height="50"><div align="right" class="STYLE5">回答：</div>
															...
															<tr>
																<td height="50"><input type="submit" name="Submit2"
																	style="height:40px; width:100px; color:#0000FF; font-size:20px; font-family: "
																	楷体="楷体" "" value="提交" /></td>
																<td height="50" align="right"><input type="reset"
																	name="Submit22"
																	style="height:40px; width:100px;color:#0000FF; font-size:20px; font-family: "
																	楷体="楷体" "" value="重置" />
																</td>
